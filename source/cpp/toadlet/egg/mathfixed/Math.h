...
namespace Math{
	...
	inline void setScaleFromMatrix3x3(Vector3 &r,const Matrix3x3 &m){
		r.x=sqrt(TOADLET_MUL_XX(m.data[0+0*3],m.data[0+0*3]) + TOADLET_MUL_XX(m.data[1+0*3],m.data[1+0*3]) + TOADLET_MUL_XX(m.data[2+0*3],m.data[2+0*3]));
		r.y=sqrt(TOADLET_MUL_XX(m.data[0+1*3],m.data[0+1*3]) + TOADLET_MUL_XX(m.data[1+1*3],m.data[1+1*3]) + TOADLET_MUL_XX(m.data[2+1*3],m.data[2+1*3]));
		r.z=sqrt(TOADLET_MUL_XX(m.data[0+2*3],m.data[0+2*3]) + TOADLET_MUL_XX(m.data[1+2*3],m.data[1+2*3]) + TOADLET_MUL_XX(m.data[2+2*3],m.data[2+2*3]));
	}
	...
	inline void setMatrix4x4FromTranslateRotateScale(Matrix4x4 &r,const Vector3 &translate,const Quaternion &rotate,const Vector3 &scale){
		...
		r.data[1+3*4]=translate.y;
		r.data[2+3*4]=translate.z;
		r.data[0+0*4]=TOADLET_MUL_XX(r.data[0+0*4],scale.x);
		r.data[1+0*4]=TOADLET_MUL_XX(r.data[1+0*4],scale.x);
		r.data[2+0*4]=TOADLET_MUL_XX(r.data[2+0*4],scale.x);
		r.data[0+1*4]=TOADLET_MUL_XX(r.data[0+1*4],scale.y);
		r.data[1+1*4]=TOADLET_MUL_XX(r.data[1+1*4],scale.y);
		r.data[2+1*4]=TOADLET_MUL_XX(r.data[2+1*4],scale.y);
		r.data[0+2*4]=TOADLET_MUL_XX(r.data[0+2*4],scale.z);
		r.data[1+2*4]=TOADLET_MUL_XX(r.data[1+2*4],scale.z);
		r.data[2+2*4]=TOADLET_MUL_XX(r.data[2+2*4],scale.z);
	}
	...
	TOADLET_API bool testIntersection(const Sphere &sphere,const Plane *planes,int numPlanes);
	TOADLET_API bool testIntersection(const AABox &box,const Plane *planes,int numPlanes);
