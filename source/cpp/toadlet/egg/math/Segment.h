...
#ifndef TOADLET_EGG_MATH_SEGMENT_H
#define TOADLET_EGG_MATH_SEGMENT_H
...
public:
	...
	inline Segment(const Segment &segment):origin(segment.origin),direction(segment.direction){}
	...
	inline Segment &setStartEnd(float startX,float startY,float startZ,float endX,float endY,float endZ){
		origin.x=startX;
		origin.y=startY;
		origin.z=startZ;
	...
	inline Segment &setStartDir(float startX,float startY,float startZ,float dirX,float dirY,float dirZ){
		origin.x=startX;
		origin.y=startY;
		origin.z=startZ;
