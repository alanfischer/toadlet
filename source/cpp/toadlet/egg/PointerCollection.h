...
public:
	...
	typedef Collection<typename TypePtr> CollectionType;
	...
	public:
		...
		inline operator CollectionType::iterator() const{return it;}
	...
	public:
		...
		inline operator CollectionType::const_iterator() const{return sit;}
