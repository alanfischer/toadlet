	...
	elseif (UNIX)
		...
		if (${BUILD_TYPE} STREQUAL "DEBUG")
			if (${CONFIGURATION} STREQUAL "RELEASE")
				set (MERGE OFF)
			else (${CONFIGURATION} STREQUAL "RELEASE")
				get_target_property (TARGETLOC ${TARGET} LOCATION_DEBUG)
			endif (${CONFIGURATION} STREQUAL "RELEASE")
		...
		if (NOT MERGE)
			message (STATUS "MergeStaticLibraries ignores mismatch betwen BUILD_TYPE and CONFIGURATION")
		else (NOT MERGE)
			configure_file (
