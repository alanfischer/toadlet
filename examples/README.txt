...
An example cmake line for building an example/android build is:
  cmake -G"NMake Makefiles" -DCMAKE_TOOLCHAIN_FILE=$TOADLET/cmake/Toolchains/Android.cmake -DANDROID_NDK=path/to/androidNdkDir -DANDROID_SDK=path/to/androidSdkDir -DCMAKE_PREFIX_PATH=path/to/toadletAndroidInstall .
