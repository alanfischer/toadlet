	...
	SceneRenderer(scene)
{
	...
	mShadowTexture=engine->getTextureManager()->createTexture(Texture::Usage_BIT_RENDERTARGET,TextureFormat::Dimension_D2,TextureFormat::Format_DEPTH_24,1024,1024,1,1);
