...
public:
	...
	bool updateVertexBufferForString(peeper::VertexBuffer::ptr vertexBuffer,const egg::String &string,const peeper::Color &color,int alignment,bool pixelSpace,bool flip);
