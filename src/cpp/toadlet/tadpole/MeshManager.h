...
public:
	...
	Mesh::ptr createSphere(peeper::VertexBuffer::ptr vertexBuffer,peeper::IndexBuffer::ptr indexBuffer,const Sphere &sphere,int numSegments,int numRings);
	...
	Mesh::ptr createSkyDome(peeper::VertexBuffer::ptr vertexBuffer,peeper::IndexBuffer::ptr indexBuffer,const Sphere &sphere,int numSegments,int numRings,scalar fade);
	...
	Mesh::ptr createGeoSphere(peeper::VertexBuffer::ptr vertexBuffer,peeper::IndexBuffer::ptr indexBuffer,const Sphere &sphere,int depth,bool icosahedron);
	...
	Mesh::ptr createTorus(peeper::VertexBuffer::ptr vertexBuffer,scalar majorRadius,scalar minorRadius,int numMajor,int numMinor);
