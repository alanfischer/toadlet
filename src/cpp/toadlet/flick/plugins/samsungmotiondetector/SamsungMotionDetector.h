...
#ifndef TOADLET_FLICK_SAMSUNGMOTIONDETECTOR_H
#define TOADLET_FLICK_SAMSUNGMOTIONDETECTOR_H
...
class SamsungMotionDetector:public FilteredMotionDetector,public egg::Runnable{
public:
	SamsungMotionDetector();
	virtual ~SamsungMotionDetector();
