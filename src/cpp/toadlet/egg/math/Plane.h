...
public:
	...
	inline Plane(const Vector3 &normal1,real distance1):normal(normal1),distance(distance1){}
	...
	inline Plane &set(const Vector3 &normal1,real distance1){
		normal.x=normal1.x;
		normal.y=normal1.y;
		normal.z=normal1.z;
	...
	inline Plane &set(real x1,real y1,real z1,real distance1){
		normal.x=x1;
		normal.y=y1;
		normal.z=z1;
