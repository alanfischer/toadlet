...
#ifndef TOADLET_EGG_MATH_CAPSULE_H
#define TOADLET_EGG_MATH_CAPSULE_H
...
class TOADLET_API TOADLET_ALIGNED Capsule{
public:
	...
	inline Capsule(const Vector3 &origin1,const Vector3 &direction1,real radius1):origin(origin1),direction(direction1),radius(radius1){}

	inline Capsule &set(const Vector3 &origin1,const Vector3 &direction1,real radius1){
		origin.x=origin1.x;
		origin.y=origin1.y;
		origin.z=origin1.z;
