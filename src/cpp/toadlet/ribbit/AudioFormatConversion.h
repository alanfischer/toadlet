...
public:
	static void decode(egg::io::Stream *stream,tbyte *&finalBuffer,int &finalLength);
	...
	static void fade(tbyte *buffer,int length,int channels,int sps,int bps,int fadeTime);
};
