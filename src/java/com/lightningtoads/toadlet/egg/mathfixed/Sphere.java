...
public final class Sphere{
	...
	public Sphere(fixed radius1){
		origin=new Vector3();
		radius=radius1;
	}

	public Sphere(Vector3 origin1,fixed radius1){
	...
	public Sphere set(Vector3 origin1,fixed radius1){
		origin.x=origin1.x;
		origin.y=origin1.y;
		origin.z=origin1.z;
	...
	public int hashCode(){
		return origin.x + origin.y + origin.z + radius;
	}
