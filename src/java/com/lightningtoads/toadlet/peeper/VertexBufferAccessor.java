...
public final class VertexBufferAccessor{
	// TODO: Move these to defines
		...
		protected static float toFloat(scalar s){return com.lightningtoads.toadlet.egg.mathfixed.Math.toFloat(s);}
		protected static scalar fromFixed(fixed x){return x;}
		protected static scalar fromFloat(float s){return com.lightningtoads.toadlet.egg.mathfixed.Math.fromFloat(s);}
	#else
		protected static fixed toFixed(scalar s){return com.lightningtoads.toadlet.egg.mathfixed.Math.fromFloat(s);}
		protected static float toFloat(scalar s){return s;}
		protected static scalar fromFixed(fixed x){return com.lightningtoads.toadlet.egg.mathfixed.Math.toFloat(x);}
