...
public final class AABox{
	...
	public AABox(real minx,real miny,real minz,real maxx,real maxy,real maxz){
		mins=new Vector3(minx,miny,minz);
		maxs=new Vector3(maxx,maxy,maxz);
	}

	public AABox(real radius){
	...
	public AABox set(real minx,real miny,real minz,real maxx,real maxy,real maxz){
		mins.x=minx;
		mins.y=miny;
		mins.z=minz;
	...
	public void setMins(real x,real y,real z){
		mins.x=x;
		mins.y=y;
		mins.z=z;
	}
	...
	public void setMaxs(real x,real y,real z){
		maxs.x=x;
		maxs.y=y;
		maxs.z=z;
	}
