...
public final class Capsule{
	...
	public Capsule(Vector3 origin1,Vector3 direction1,fixed radius1){
	...
	public Capsule set(Vector3 origin1,Vector3 direction1,fixed radius1){
		origin.x=origin1.x;
		origin.y=origin1.y;
		origin.z=origin1.z;
	...
	public void setOrigin(fixed x,fixed y,fixed z){
		origin.x=x;
		origin.y=y;
		origin.z=z;
	}
	...
	public void setDirection(fixed x,fixed y,fixed z){
		direction.x=x;
		direction.y=y;
		direction.z=z;
	}
	...
	public void setRadius(fixed radius1){
		radius=radius1;
	}
	...
	public void setLength(fixed length){
		if(length>=(radius<<1)){
	...
	public int hashCode(){
		return origin.hashCode() + direction.hashCode() + radius;
	}
