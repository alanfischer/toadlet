...
public final class Segment{
	...
	public Segment setStartEnd(fixed startX,fixed startY,fixed startZ,fixed endX,fixed endY,fixed endZ){
		origin.x=startX;
		origin.y=startY;
		origin.z=startZ;
	...
	public Segment setStartDir(fixed startX,fixed startY,fixed startZ,fixed dirX,fixed dirY,fixed dirZ){
		origin.x=startX;
		origin.y=startY;
		origin.z=startZ;
