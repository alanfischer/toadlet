...
public class Entity{
	...
	public void setTranslate(Vector3 translate){
		...
		mTransform.m03=mTranslate.x>>bits;
		mTransform.m13=mTranslate.y>>bits;
		mTransform.m23=mTranslate.z>>bits;
	...
	public void setRotate(Matrix3x3 rotate){ 
		...
		mTransform.m00=Math.mul(mRotate.at(0,0),mScale.x)>>4;
		mTransform.m10=Math.mul(mRotate.at(1,0),mScale.x)>>4;
		mTransform.m20=Math.mul(mRotate.at(2,0),mScale.x)>>4;
		mTransform.m01=Math.mul(mRotate.at(0,1),mScale.y)>>4;
		mTransform.m11=Math.mul(mRotate.at(1,1),mScale.y)>>4;
		mTransform.m21=Math.mul(mRotate.at(2,1),mScale.y)>>4;
		mTransform.m02=Math.mul(mRotate.at(0,2),mScale.z)>>4;
		mTransform.m12=Math.mul(mRotate.at(1,2),mScale.z)>>4;
		mTransform.m22=Math.mul(mRotate.at(2,2),mScale.z)>>4;
	...
	AffineTrans mTransform=new AffineTrans();
	AffineTrans mWorldTransform=new AffineTrans();
}
